...
public class LaunchLuiUrlIfFailureJob extends StackableJob {
    ...
    public void executeAfterEarlierFailure() {
        if (mJobManager.getCallbackHandler() == null) {
            ...
            // Log.d(Constants.LOGTAG, "Using LUI_URL to launch browser");
            ...
            if (mJobManager.getParameters().containsKey("REDIRECT_URL")
                ...
                mJobManager.addParameter("REDIRECT_URL", mLuiUrl);
            }
        }
    }
    ...
    public boolean writeToDB(DrmJobDatabase msDb) {
        ...
        values.put(DatabaseConstants.COLUMN_NAME_GENERAL1, this.mLuiUrl);
